...
function buildSidebar() {
  ...
  aside.innerHTML = `
    <div class="artist-sidebar__profile-wrap">
      <div class="artist-sidebar__profile" id="artistSidebarProfileToggle">
        <img class="artist-sidebar__avatar" id="artistSidebarAvatar" src="/assets/img/dash/default-avatar.png" alt="Photo de profil" />
  ...
  onAuthStateChanged(auth, async (user) => {
    ...
    if (!user) {
      ...
      if (avatar) avatar.src = "/assets/img/dash/default-avatar.png";
      return;
    }
    ...
    if (avatar) {
      avatar.src = avatarUrl || "/assets/img/dash/default-avatar.png";
      avatar.onerror = () => {
        avatar.onerror = null;
        avatar.src = "/assets/img/dash/default-avatar.png";
      };
    }
  });
}
